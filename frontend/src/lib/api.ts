...
export const coeApi = {
  ...
  updateSession: (id: string, data: Record<string, unknown>) => api.patch(`/coe/sessions/${id}`, data),
  ...
  uploadSessionMeetingNotes: (id: string, data: FormData) => api.post(`/coe/sessions/${id}/meeting-notes`, data, { headers: { 'Content-Type': 'multipart/form-data' } }),
  getSessionMeetingNotesDownload: (id: string, noteId: string) => api.get(`/coe/sessions/${id}/meeting-notes/${noteId}/download`),
  deleteSessionMeetingNote: (id: string, noteId: string) => api.delete(`/coe/sessions/${id}/meeting-notes/${noteId}`),
