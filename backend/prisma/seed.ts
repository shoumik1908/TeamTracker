...
async function main() {
  ...
  const azureFundamentals = await prisma.certification.create({
    data: {
  ...
  const azureDevOps = await prisma.certification.create({
    data: {
  ...
  const awsSolutions = await prisma.certification.create({
    data: {
  ...
  const gcpProfessional = await prisma.certification.create({
    data: {
  ...
  const kubernetesAdmin = await prisma.certification.create({
    data: {
  ...
  const scrumMaster = await prisma.certification.create({
    data: {
